...
---@class MiniMapHelper3
local MiniMapHelper3 = class("MiniMapHelper3")

---@param track_content_path string
---@param max_size vec2
function MiniMapHelper3:initialize(track_content_path, max_size)
...
---@private
---@return vec2
function MiniMapHelper3:worldToMap(coord)
...
function MiniMapHelper3:drawMap(origin, bounding_box)
    ...
    --     origin,
    --     self._track_map_data.size * self._track_map_data.scale_factor,
    --     rgbm(1, 1, 1, 0.2)
    -- )
    -- ui.drawRect(bounding_box_p1, bounding_box_p2, rgbm(1, 0.5, 0.2, 1))
    ...
    --     self._track_map_image_path,
    --     origin,
    --     vec2(scaled_width, scaled_height),
    --     rgbm(1, 1, 1, 0.1)
    -- )
    -- ui.drawRect(bounding_box_p1, bounding_box_p2, rgbm(1, 0.5, 0.2, 1))
    ...
    --ui.drawCircleFilled(scaled_bbox_center, 3, rgbm.colors.red)
    ...
    --ui.drawCircleFilled(origin + scaled_bbox_center - desired_offset, 3, rgbm.colors.red)
end

function MiniMapHelper3:mapCoord(coord)
...
function MiniMapHelper3:drawBoundingBox(origin)
end

function MiniMapHelper3:drawCar(origin, idx)
...
function MiniMapHelper3:drawTrackConfig(origin, track_config)
