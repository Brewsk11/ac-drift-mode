...
ObjectEditorPoi                = require('drift-mode/models/CourseEditor/POIs/ObjectEditorPoi')
PoiClip                        = require('drift-mode/models/CourseEditor/POIs/PoiClip')
PoiSegment                     = require('drift-mode/models/CourseEditor/POIs/PoiSegment')
PoiStartingPoint               = require('drift-mode/models/CourseEditor/POIs/PoiStartingPoint')
PoiZone                        = require('drift-mode/models/CourseEditor/POIs/PoiZone')
EditorRoutine                  = require('drift-mode/models/CourseEditor/Routines/EditorRoutine')
RoutineExtendPointGroup        = require('drift-mode/models/CourseEditor/Routines/RoutineExtendPointGroup')
RoutineMovePoi                 = require('drift-mode/models/CourseEditor/Routines/RoutineMovePoi')
RoutineSelectSegment           = require('drift-mode/models/CourseEditor/Routines/RoutineSelectSegment')
