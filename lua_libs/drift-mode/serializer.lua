...
MAP_271_MIGRATION = {
    ...
    DrawerPointGroup = "Common.Point.Drawers.BaseGroup",
    DrawerPointGroupConnected = "Common.Point.Drawers.GroupConnected",
    DrawerPointGroupSimple = "Common.Point.Drawers.GroupSimple",
    ...
    PointGroup = "Common.Point.PointGroup",
    Segment = "Common.Segment.Segment",
    SegmentGroup = "Common.Segment.SegmentGroup",
