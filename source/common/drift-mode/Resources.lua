...
local Resources = {
    ...
    Colors = {
        ...
        ScorableInactive = rgbm(0.1, 0.3, 1, 1),
        ScorableActive = rgbm(0.05, 1, 0.05, 1),
        ScorableDone = rgbm(0.5, 1, 0.1, 1),
        ScorableBad = rgbm(0.8, 0.3, 0.3, 1),
        ScorableGood = rgbm(0.3, 0.8, 0.3, 1),
        ScorableOutside = rgbm(1, 0.2, 0.2, 1),
