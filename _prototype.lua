...
Zone.Model.__model_path = "TrackObjects.Zone:Model"

Zone.State = class("Zone.State")
Zone.Model.__model_path = "TrackObjects.Zone:State"

Zone.Drawers = {}

Zone.Drawers.Base = class("Zone:Drawers:Base", Common.DrawerBase)
Zone.Drawers.Base.__model_path = "TrackObjects.Zone:State"

Zone.Drawers.Run = class("Zone:Drawers:Run", Zone.Drawers.Base)
Zone.Drawers.Run.__model_path = "TrackObjects.Zone:Drawers:Base"

Zone.Drawers.Setup = class("Zone:Drawers:Setup", Zone.Drawers.Base)
Zone.Drawers.Setup.__model_path = "TrackObjects.Zone:Drawers:Setup"
